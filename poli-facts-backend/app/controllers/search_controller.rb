...
class SearchController < ApplicationController
  ...
  def show
    ...
    # if state != nil
      ...
      # senateResponse = RestClient.get("https://api.propublica.org/congress/v1/members/#{params[:query]}/current", headers={"X-API-KEY":"Jv6lbl95ZWrgwK8bThHUaXcaVfojPdqG6V7rR3QY"})
