...
class SearchController < ApplicationController
  ...
  def show
    ...
    if state != nil
      ...
      congressResponse = RestClient.get("https://api.propublica.org/congress/v1/115/senate/members/", headers={"X-API-KEY":"Jv6lbl95ZWrgwK8bThHUaXcaVfojPdqG6V7rR3QY"})
      # returnData = JSON.parse(response)
      returnCongress = JSON.parse(congressResponse)
